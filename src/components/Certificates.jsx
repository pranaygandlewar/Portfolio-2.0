...
const CertificateCard = ({ cert, aosDelay }) => (
  <div 
    ...
    className="bg-black/5 backdrop-blur-sm rounded-2xl p-5 border border-black/10 hover:border-black/25 hover:scale-105 hover:shadow-[0_15px_40px_rgba(0,0,0,0.1)] transition-all duration-500 cursor-default group"
  >
    <div className="flex items-start gap-4">
      <span className="text-2xl mt-0.5 group-hover:scale-110 transition-transform duration-300">{cert.icon}</span>
      <div>
        <h3 className="text-[#08080a] font-bold text-sm md:text-base leading-tight mb-1 group-hover:text-black transition-colors">
          {cert.name}
        </h3>
        <p className="text-[#08080a]/60 text-xs font-semibold uppercase tracking-wider">
          {cert.issuer}
        </p>
      </div>
    </div>
...
const Certificates = () => {
  return (
    <section className="bg-[#e3dfd5] text-[#08080a] pt-20 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-12 md:mb-16 text-center">
          <h2 className="text-4xl md:text-5xl font-black text-[#08080a] mb-4 tracking-tight">
            Certifications
          </h2>
        ...
        <div data-aos="fade-up" data-aos-delay="700" className="flex justify-center">
          ...
          >
            <svg className="w-5 h-5 text-[#08080a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
