...
const Education = () => {
  return (
    <section id="education" className="bg-[#0a0a0a] pt-24 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="absolute top-1/4 left-10 w-96 h-96 bg-[#e3dfd5]/5 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-10 w-96 h-96 bg-[#e3dfd5]/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div 
          data-aos="fade-up"
          className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 md:p-12 hover:border-[#e3dfd5]/30 hover:shadow-[0_20px_50px_rgba(227,223,213,0.15)] transition-all duration-500 max-w-3xl mx-auto"
        >
          <div className="flex flex-col md:flex-row justify-between md:items-center gap-6 pb-6 border-b border-white/10 mb-6">
            <div>
              <span className="text-[#e3dfd5] text-xs font-mono font-bold tracking-widest uppercase py-1 px-3 border border-[#e3dfd5]/30 rounded-full bg-[#e3dfd5]/10">
                {education.duration}
              </span>
            ...
            <div className="text-white/60 text-sm font-mono text-left md:text-right">
              <p className="font-bold text-[#e3dfd5]">{education.location}</p>
            </div>
          </div>
